...
public class ScaleGestureDetector {
	...
	public ScaleGestureDetector(Context context, SimpleOnScaleGestureListener simpleOnScaleGestureListener) {
		try {
			...
			Class<?> classRealScaleGestureDetector = Class.forName("com.tradersgem.GraphView.compatible.RealScaleGestureDetector");
			...
			// not available
			Log.w("com.tradersgem.GraphView", "*** WARNING *** No scaling available for graphs. Exception:");
			e.printStackTrace();
		}
	}
